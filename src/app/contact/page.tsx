    ...
    <>
      ...
      <section className="relative bg-primary text-white py-20 md:py-28 overflow-hidden">
        <div className="absolute inset-0">
          <Image src="/images/banner-1_orig.png" alt="Contact Us" fill className="object-cover opacity-20" />
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <div className="mt-8 reveal reveal-delay-4">
                <div className="relative h-64 rounded-lg overflow-hidden">
                  <Image src="/images/luke_orig.png" alt="Luke Buchanan" fill className="object-cover object-top" />
                  <div className="absolute inset-0 bg-gradient-to-t from-primary/80 to-transparent"></div>
                  <div className="absolute bottom-4 left-4 text-white">
                    <p className="font-display text-xl">LUKE BUCHANAN</p>
                    <p className="text-sm opacity-80">Owner & Lead Plumber</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-surface p-8 md:p-10 reveal reveal-delay-4">
              ...
              >
                <div>
                  <label htmlFor="name" className="block text-sm font-medium text-text-main mb-2">Your Name *</label>
                  <input
                    type="text"
                    id="name"
                    name="name"
                ...
                <div>
                  <label htmlFor="service" className="block text-sm font-medium text-text-main mb-2">Service Required</label>
                  <select
                    id="service"
                    name="service"
        ...
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4 reveal reveal-delay-1">
            {['Murwillumbah', 'Tweed Valley', 'Tweed Heads', 'Stokers Siding', 'Uki', 'Tyalgum', 'Burringbar', 'Kingscliff', 'Pottsville', 'Cabarita Beach'].map((area, index) => (
              <span key={index} className="bg-white/10 px-6 py-3 font-display">{area}</span>
            ))}
          </div>
        </div>
      </section>
